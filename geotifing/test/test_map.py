...
class TestGeotifyMapVisualizer(unittest.TestCase):
    ...
    def test_load_geojson_file_path_default_path(self, mock_getenv):
        ...
        expected_path = "/Users/songle/Geotify/asset/skorea_municipalities_geo_simple.json"
    ...
    @patch('geotify.map.gpd.read_file', side_effect=ValueError("Error loading GeoJSON file"))
